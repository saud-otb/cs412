...
urlpatterns = [
    ...
    path(r'profile/<int:pk>/follow', FollowProfileView.as_view(), name='follow_profile'),
    path(r'profile/<int:pk>/delete_follow', DeleteFollowView.as_view(), name='delete_follow_profile'),
    path(r'post/<int:pk>/like', LikePostView.as_view(), name='like_post'),
    path(r'post/<int:pk>/delete_like', DeleteLikeView.as_view(), name='delete_like_post'),
]